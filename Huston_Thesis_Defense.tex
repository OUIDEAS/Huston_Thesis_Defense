		...
		\subsection{Task 2}\label{sec:Objective_2_Task_2}{
			...
			\subsubsection{Visual Road Detection}\label{sec:manual_road_detection}{
				...
				\begin{figure}[H]
					...
					\caption[Projected Guess vs Truth]{Gravel surfaces were manually guessed and compared to actual gravel surface areas. Not shown is a similar method employed to compare guessed versus actual asphalt areas}
...
%		dvg_example
	...
	\section{Visual Detection of Unmarked Road Surfaces}{
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.95\linewidth]{Defense_Images/ransac_db_6_overlap_2}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.95\linewidth]{Defense_Images/mls_db_6_overlap_2}
